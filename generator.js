    ...
    const cargarPeliculas = async() => {
        ...
        if (isSerie.checked) {
            try {
                ...
                const respuesta = await fetch(`https://api.themoviedb.org/3/tv/${serieKey}?api_key=522d421671cf75c2cba341597d86403a&language=${languaje}`);
                const respuesta3 = await fetch(`https://api.themoviedb.org/3/tv/${serieKey}/season/${seasonNumber}?api_key=522d421671cf75c2cba341597d86403a&language=${languaje}`);
...
${episodeList}
        ...
        if(isMovie.checked){
            ...
            const respuesta = await fetch(`https://api.themoviedb.org/3/movie/${serieKey}?api_key=522d421671cf75c2cba341597d86403a&language=${languaje}`);
